...
> (`docs/mau-tai-lieu/locale-vi/project-closure-story/`). Chuyển từ giao hàng một lần
...
Các mục dưới đi theo Change Request (`docs/mau-tai-lieu/locale-vi/change-request-log.md`
...
Dùng cùng thang với `docs/mau-tai-lieu/locale-vi/change-request-log.md` § Severity.
...
1. Khách mở một entry trong `docs/mau-tai-lieu/locale-vi/change-request-log.md` (hoặc
...
- Bản gốc tiếng Anh (chuẩn): `docs/mau-tai-lieu/maintenance-proposal.md`.
- Log sự cố: `docs/incidents/` (repo dự án).
- Change Request log: `docs/mau-tai-lieu/locale-vi/change-request-log.md`.
- Bàn giao dự án: `docs/mau-tai-lieu/locale-vi/project-closure-story/` (đề xuất này gửi kèm).
