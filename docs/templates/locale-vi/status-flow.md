...
Đối chiếu với `docs/templates/locale-vi/role-permission-matrix.md` để đảm bảo mọi
...
- [ ] Mọi vai trò được phép khớp với `docs/templates/locale-vi/role-permission-matrix.md`.
...
- Bản gốc tiếng Anh (chuẩn): `docs/templates/status-flow.md`.
