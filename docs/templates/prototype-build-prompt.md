...
- LƯU localStorage (no backend). Nút Export feedback (JSON) → khớp docs/templates/prototype-feedback-round.md; nút Import nạp lại. Đây là kênh thu feedback của step 1.13.
