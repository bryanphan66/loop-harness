...
- Bản gốc tiếng Anh (chuẩn): `docs/templates/feature-register.md`.
- Nguồn gap (GAP-NNN): `docs/templates/locale-vi/gap-analysis.md` (1.4).
...
- Forward: báo giá (1.14) `docs/templates/locale-vi/bao-gia/` + SOW `docs/templates/locale-vi/proposal-sow.md`.
- Change requests sau đóng băng: `docs/templates/locale-vi/change-request-log.md`.
- Token grammar + RTM completeness rule: `docs/TRACE_SPEC.md`. Cổng: `docs/WORKFLOW.md`.
