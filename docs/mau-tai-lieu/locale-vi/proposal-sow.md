...
> nào trước cổng này**.
>
> Đọc kèm bộ `docs/mau-tai-lieu/locale-vi/bao-gia/` (bảng giá + điều khoản chi tiết).
...
> Bảng giá chi tiết và tổng giá trị hợp đồng: `docs/mau-tai-lieu/locale-vi/bao-gia/01-bao-gia-du-an.md`.

## 9. Chính sách Change Request (Yêu cầu phát sinh)

Mọi yêu cầu ngoài § 4 (sau `PB-G4`) đi theo quy trình Change Request
(`docs/mau-tai-lieu/locale-vi/change-request-log.md` → đúc `CR-NN`):
...
- Các test case UAT của mốc đó pass (theo `docs/mau-tai-lieu/locale-vi/delivery-closure-story/01-uat-plan.md`).
...
- Ký nghiệm thu qua `docs/mau-tai-lieu/locale-vi/delivery-closure-story/02-signoff-nghiem-thu.md`.
...
- Chi tiết: `docs/mau-tai-lieu/locale-vi/bao-gia/02-dieu-khoan-bao-hanh.md`.
- Bảo trì dài hạn (tùy chọn): `docs/mau-tai-lieu/locale-vi/maintenance-proposal.md`.
...
- Bản gốc tiếng Anh (chuẩn): `docs/mau-tai-lieu/proposal-sow.md`.
- Bộ báo giá chi tiết: `docs/mau-tai-lieu/locale-vi/bao-gia/` (01..05 + README).
- Nguồn scope (đóng băng PB-G2): `docs/mau-tai-lieu/locale-vi/feature-register.md`.
- Đóng dự án (UAT, signoff, client update — tại M3/M4): `docs/mau-tai-lieu/locale-vi/delivery-closure-story/`.
- Bàn giao (M5): `docs/mau-tai-lieu/locale-vi/project-closure-story/`.
- Change requests: `docs/mau-tai-lieu/locale-vi/change-request-log.md`.
- Bảo trì: `docs/mau-tai-lieu/locale-vi/maintenance-proposal.md`.
- Bản đồ macro-stage + cổng: `docs/process/WORKFLOW.md`. Token grammar: `docs/about/TRACE_SPEC.md`.
