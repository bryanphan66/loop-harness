...
Sau khi đóng băng, thay đổi gap đi qua `docs/mau-tai-lieu/locale-vi/change-request-log.md`.
Không sửa analysis tại chỗ — ghi chú trỏ tới `CR-NN`.

## Cross-References

- Bản gốc tiếng Anh (chuẩn): `docs/mau-tai-lieu/gap-analysis.md`.
- Nguồn business problem: `docs/mau-tai-lieu/locale-vi/client-intake-brief.md § 3` (1.2).
...
- Forward: feature-register in-scope (1.9) → `docs/mau-tai-lieu/locale-vi/feature-register.md`.
- Token grammar đầy đủ: `docs/about/TRACE_SPEC.md`.
