...
1. **REQ candidate list** — markdown table. These become REQ-IDs at SRS
   ...
   when the candidate lands in an SRS module (see `docs/about/TRACE_SPEC.md`).
...
- `docs/about/TRACE_SPEC.md` § Token Types — REQ-ID format the candidates become.
...
- `docs/about/ROLE_MAP.md` — BA role + `ck-rri` engine binding.
