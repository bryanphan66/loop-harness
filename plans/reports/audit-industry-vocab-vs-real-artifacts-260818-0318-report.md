...
**Ngày:** 2026-08-18 · **Phạm vi:** verify từng dòng `harness/docs/about/KEYWORD-MAP.md § H` (bảng "tên nhà <-> tên ngành") xem có artifact thật cưỡng chế khái niệm hay chỉ là chữ trong doc · **Cách:** quét read-only harness/ (docs, scripts, templates, .claude/commands, hooks).
