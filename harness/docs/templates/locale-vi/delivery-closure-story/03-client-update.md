...
- Bản gốc tiếng Anh (chuẩn): `docs/templates/delivery-closure-story/03-client-update.md`.
- Kế hoạch UAT: `docs/templates/locale-vi/delivery-closure-story/01-uat-plan.md`.
- Biên bản nghiệm thu: `docs/templates/locale-vi/delivery-closure-story/02-signoff-nghiem-thu.md`.
- Release note: `docs/templates/locale-vi/release-note.md`.
