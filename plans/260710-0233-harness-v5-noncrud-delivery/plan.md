...
Modified: `docs/templates/build-manifest.md`, `docs/playbooks/build-manifest-compilation.md`, `docs/gates/phase-acceptance.md`, `docs/STAGE_GOALS.md` (2.2/2.3), `docs/WORKFLOW.md`, `docs/playbooks/README.md`, `docs/HARNESS.md`, `docs/HARNESS_CHANGELOG.md`, stack `docker-compose*`, `TEMPLATE_VERSION`.
