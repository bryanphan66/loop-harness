...
> (`docs/templates/locale-vi/delivery-closure-story/01-uat-plan.md`) và thông báo
...
(`docs/templates/locale-vi/proposal-sow.md` § 7) nếu có.
...
`docs/templates/locale-vi/delivery-closure-story/03-client-update.md` và chèn tóm tắt
từ § 1.
...
- Bản gốc tiếng Anh (chuẩn): `docs/templates/release-note.md`.
- Kế hoạch UAT gating release: `docs/templates/locale-vi/delivery-closure-story/01-uat-plan.md`.
- Hồ sơ signoff: `docs/templates/locale-vi/delivery-closure-story/02-signoff-nghiem-thu.md`.
- Template báo khách: `docs/templates/locale-vi/delivery-closure-story/03-client-update.md`.
- Change request đã vào release này: `docs/templates/locale-vi/change-request-log.md` (lọc theo release tag).
- Token grammar: `docs/TRACE_SPEC.md`. Cổng + macro-stage: `docs/WORKFLOW.md`.
