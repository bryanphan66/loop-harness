...
> **Step:** 1.2 (`docs/WORKFLOW.md`). **Output:** `docs/intake/{date}-intake-brief.md`.
...
- [ ] The client's core business problem is stated in one paragraph (becomes the head of the token chain — `docs/TRACE_SPEC.md`).
