...
Bilingual: client-facing → fork to docs/mau-tai-lieu/locale-vi/maintenance-proposal.md (D4)
...
- Localization: forks to `docs/mau-tai-lieu/locale-vi/maintenance-proposal.md` (D4).
