...
> "Số câu hỏi BLOCKER còn mở" trong `docs/mau-tai-lieu/locale-vi/feature-register.md § 3`.
...
> `docs/mau-tai-lieu/locale-vi/feature-register.md` · token grammar `docs/process/TRACE_SPEC.md`.
