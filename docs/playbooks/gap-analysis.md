...
zero-padded counter per `docs/TRACE_SPEC.md`). The token traces forward when
...
- `docs/TRACE_SPEC.md` § Token Types — GAP-NNN format + chain position.
- `docs/WORKFLOW.md` § 1.4 — the step this playbook owns.
...
- `docs/ROLE_MAP.md` — BA role + `researcher` engine binding.
