...
> **ACCEPTANCE** gate (step 2.12). **Step:** 2.10 (`docs/process/WORKFLOW.md`).
...
- [ ] **RTM forward-complete** (`docs/process/TRACE_SPEC.md`): every REQ-ID → ≥1 TC-NNN with `Result: pass` in the verification register.
...
Verification register:             docs/about/TEST_MATRIX.md  (all pass / reasons recorded)
