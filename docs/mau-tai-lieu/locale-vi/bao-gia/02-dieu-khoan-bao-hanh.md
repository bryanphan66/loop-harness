...
> Chi tiết đầy đủ: `docs/mau-tai-lieu/locale-vi/maintenance-proposal.md`. Tóm tắt nhanh
...
> Bản gốc tiếng Anh (surface chung): `docs/mau-tai-lieu/maintenance-proposal.md`.
